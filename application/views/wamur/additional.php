            ...
            <div class="row text-center">
                <?php foreach ($foto as $f) : ?>
                    <div class="col-sm-3 col-lg-3 col-md-3">
                        <div class="card">
                            <!-- pecah string ambil 3 huruf akhir -->
                            <?php $jenis = substr($f['nama_file'], -3); ?>

                            <!-- jika nama file mbd -->
                            <?php if ($jenis == 'mbd') : ?>
                                <!-- thumbnail -->
                                <!-- ganti nama youtube menjadi embed -->
                                <?php $yt = str_replace('youtu.be/', 'youtube.com/embed/', $f['jenis_file']);
                                ?>
                                <!-- dan tampilkan embed youtube  -->
                            ...
                            <?php else : ?>
                                <!-- cek jenisnya apa -->
                                <?php if ($jenis == 'jpg' or $jenis == 'jpeg' or $jenis == 'png') {
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-left text-left"><?= $ket ?><br> <?= date('d/m/Y', $f['date_created']) ?></p>
